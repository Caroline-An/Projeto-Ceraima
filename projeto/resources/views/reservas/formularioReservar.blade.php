            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <a class="nav-link align-itens-left text-left mt-4 mb-4 ms-2 me-2 p-2 itens-menu-lateral" href="{{ route('reserva.create')}}">
    ...
    <div class="container-fluid">
        ...
        <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
            <div class="row d-flex w-auto">
                ...
                <form action="{{ route('reserva.show')}}" method="post" class="m-0 p-0 formulario">
