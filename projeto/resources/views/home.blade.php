            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <a class="nav-link align-itens-left text-left mt-4 mb-4 ms-2 me-2 p-2 itens-menu-lateral" href="{{ route('item.show') }}">
    ...
    <div class="container-fluid">
        <div class="ms-5 me-5 mt-1 mb-1 container-conteudo bg-light p-4">
            <div class="row d-flex justify-content-around ">
                ...
                <div class="w-auto d-flex justify-content-center">
                    <a class="m-2 itens-home-page text-center" href="{{ route('item.create') }}">
                ...
                <div class="w-auto d-flex justify-content-center">
                    <a class="m-2 itens-home-page text-center" href="{{ route('item.show') }}">
                ...
                <div class="w-auto d-flex justify-content-center">
                    <a class="m-2 itens-home-page text-center" href="{{ route('reserva.categ') }}">
                ...
                <div class="w-auto d-flex justify-content-center">
                    <a class="m-2 itens-home-page text-center" href="{{ route('reserva.show') }}">
